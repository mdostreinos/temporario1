...
<div class="container admin-container">
    <?php if (!$is_detail_view_mode): ?>
        <h1 style="text-align: center; margin-bottom: 20px; color: #007bff;">[NOME DA APLICAÇÃO]</h1>
        ...
        <div id="detailedViewSection" class="detailed-view-section">
            ...
            <?php elseif ($detailed_document): ?>
                ...
                <div style="margin-top: 20px;">
                    ...
                    <a href="<?php echo htmlspecialchars($back_url); ?>" class="button-secondary" style="margin-left:10px;">Voltar à Lista</a>
                </div>
            <?php else: ?>
