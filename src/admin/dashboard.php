...
<style>
    ...
    .admin-header { background-color: #FFFFFF !important; padding: 0 !important; margin-bottom: 20px; }
    .admin-header h1 { background-color: transparent !important; color: #007bff; padding: 0; text-align: center; }
