...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action'])) {
    ...
    switch ($action) {
        ...
        case 'edit_user':
            // ... (código de editar usuário como está, não precisa de alteração) ...
        ...
        case 'delete_user':
            // ... (código de excluir usuário como está, não precisa de alteração) ...
        ...
        case 'reset_password':
            // ... (código de resetar senha como está, não precisa de alteração) ...
