<?php
// Ensure session and auth functions are available first.
if (!function_exists('is_admin')) {
    require_once __DIR__ . '/../auth.php';
}
start_secure_session();

// db_connect.php might be included by the calling script already, but good to ensure.
...
// --- ADIÇÃO PARA O EASTER EGG: Prepara o H1 com o gatilho ---
...
<head>
    ...
    <style>
        /* Efeito de blur no conteúdo principal da página */
        body.ring-egg-active > header,
        body.ring-egg-active > main {
        ...
        #one-ring-text {
            ...
            color: #FFD700; font-family: 'Times New Roman', Times, serif; font-size: 2.5em;
            text-align: center; z-index: 9999; opacity: 0; transition: opacity 1s ease-in;
            text-shadow: 0 0 5px #ffa500, 0 0 10px #ffa500, 0 0 15px #ff4500;
            pointer-events: none;
        }
        header { user-select: none; }
        #easter-egg-trigger { cursor: default; }
    </style>
</head>
<body>
